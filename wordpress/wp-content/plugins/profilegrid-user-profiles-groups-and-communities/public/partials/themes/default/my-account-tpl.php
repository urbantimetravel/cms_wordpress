...
<form class="pmagic-form pm-dbfl" method="post" action="" id="pm_my_account" name="pm_my_account" onsubmit="return pm_save_account_setting(this);">
     ...
     <div class="pmrow">        
        <div class="pm-col">
            <div class="pm-form-field-icon"></div>
            <div class="pm-field-lable">
                <label for="first_name"><?php _e('First Name','profilegrid-user-profiles-groups-and-communities');?><sup class="pm_estric">*</sup></label>
            </div>
            <div class="pm-field-input pm_required">
    ...
    <div class="pmrow">        
        <div class="pm-col">
            <div class="pm-form-field-icon"></div>
            <div class="pm-field-lable">
                <label for="last_name"><?php _e('Last Name','profilegrid-user-profiles-groups-and-communities');?><sup class="pm_estric">*</sup></label>
            </div>
            <div class="pm-field-input pm_required">
