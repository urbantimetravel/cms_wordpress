...
//                endif;
   ...
   ?>
    ...
    public function pm_save_custom_permalink_option()
    {
        ...
        if ( isset( $_POST['permalink_structure'], $_POST['pg-permalinks-nonce'], $_POST['pm_blog_base']) && wp_verify_nonce( wp_unslash( $_POST['pg-permalinks-nonce'] ), 'pg-permalinks' ) ) 
        {
            $dbhandler = new PM_DBhandler;
            $dbhandler->update_global_option_value('pm_blog_base',$_POST['pm_blog_base']);

            if(isset($_POST['pm_group_wall_base']))
            {
                $dbhandler->update_global_option_value('pm_group_wall_base',$_POST['pm_group_wall_base']);
            }
    ...
    {
         echo wpautop( "You can define the slugs for posts created through ProfileGrid’s native user blogs system and Group Wall extension." );
    }
    ...
    public function pm_blog_base_callback(){
        ...
        <label for="pm_blog_base">
            <input name="pm_blog_base" id="pm_blog_base" type="text" value="<?php echo $blog_base;?>" class="regular-text code" autocomplete="off">
        </label>
        <?php
    ...
    public function pm_group_wall_base_callback(){
        ...
        <label for="pm_group_wall_base">
            <input name="pm_group_wall_base" id="pm_group_wall_base" type="text" value="<?php echo $group_wall_base;?>" class="regular-text code" autocomplete="off">
        </label>
        <?php
    }
