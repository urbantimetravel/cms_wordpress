...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_performance_settings' ) ) die( __('Failed security check','profilegrid-user-profiles-groups-and-communities') );
...
<div class="uimagic">
  <form name="pm_performance_settings" id="pm_performance_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'ProfileGrid Peformance','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      ...
      <div class="uimsubheader">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Combine JS','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Turn on the payment system(s) you want to use for accepting payments. Make sure you configure them right.','profilegrid-user-profiles-groups-and-communities');?></div>
         ...
         <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Combine CSS','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
