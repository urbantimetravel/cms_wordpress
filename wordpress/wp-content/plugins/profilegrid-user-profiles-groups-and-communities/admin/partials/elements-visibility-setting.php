...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_elements_visibility_settings' ) ) die( __('Failed security check','profilegrid-user-profiles-groups-and-communities') );
...
<div class="uimagic">
  <form name="pm_elements_visibility_settings" id="pm_elements_visibility_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Elements Visibility','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      <div class="uimrow" id="pm_elements_visibilityp-page-head">
          <div class="uimfield">  <h2><?php _e('Profiles Page','profilegrid-user-profiles-groups-and-communities');?></h2></div>
       <div class="pg-uim-notice"><?php _e('Use toggle buttons below to turn on or off labelled elements.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
        <div class="uimrow" id="default_registration_form_heading">
            <h3><?php _e('User Profile Header Area','profilegrid-user-profiles-groups-and-communities');?></h3>
      </div>
        
        
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Profile Cover Image:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Show option to change cover image:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Show option to change Profile image:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
       ...
       <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Profile Tags:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
       ...
       <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'User Group(s) Name:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'User Group Badges:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimrow">
            <h3><?php _e('User Profile Content Area','profilegrid-user-profiles-groups-and-communities');?></h3>
      </div>
        <div class="uimrow">
            <h4><?php _e('About Tab','profilegrid-user-profiles-groups-and-communities');?></h4>
      </div>
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Edit Profile Button:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Left Menu:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
...
<!--        <div class="uimrow">
        ...
        <div class="uimrow">
            <h4><?php _e('Blog Tab','profilegrid-user-profiles-groups-and-communities');?></h4>
      </div>
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'New Blog Post Button:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Blog Post Time:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Blog Post Comment Count:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Blog Post Thumbnail:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimrow" id="default_registration_form_heading">
            <h4><?php _e('Notification Tab','profilegrid-user-profiles-groups-and-communities');?></h4>
      </div>
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Show View Links:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
       ...
       <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Show Title Links:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimrow">
            <h4><?php _e('Groups Tab','profilegrid-user-profiles-groups-and-communities');?></h4>
      </div>
        
        
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Title Links to Group Pages:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Group Card Menu:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="childfieldsrow" id="enable_profile_group_card_menu_html" style=" <?php if($dbhandler->get_global_option_value('pm_show_user_group_card_menu',1)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
            ...
            <div class="uimrow">
                <div class="uimfield">
                  <?php _e( 'Leave Group:','profilegrid-user-profiles-groups-and-communities' ); ?>
                </div>
                <div class="uiminput">
        ...
        <div class="uimrow">
            <h2><?php _e('Individual Group Page (Applies to all Groups)','profilegrid-user-profiles-groups-and-communities');?></h2>
        </div>
        
         <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Group Card:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Leave Group Button:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
       ...
       <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Group Managers Field:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
       ...
       <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Members Field:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Group Details:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uiminput">
         ...
         <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Discussions','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
      ...
      <?php endif; ?>
         ...
         <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Photos','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
      ...
      <?php endif; ?>
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Settings','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="childfieldsrow" id="enable_group_settings_tab_html" style=" <?php if($dbhandler->get_global_option_value('pm_show_group_settings_tab',1)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
            ...
            <div class="uimrow">
             ...
             <div class="uimrow">
                <div class="uimfield">
                  <?php _e( 'Blog','profilegrid-user-profiles-groups-and-communities' ); ?>
                </div>
                <div class="uiminput">
        ...
        <?php endif; ?>
        <div class="uimrow">
            <div class="uimfield"><h2><?php _e('All Groups Page','profilegrid-user-profiles-groups-and-communities');?></h2></div>
      <div class="pg-uim-notice"><?php _e(' Choose which User Groups you wish to display on All Groups page.','profilegrid-user-profiles-groups-and-communities');?></div>
     </div>
        ...
        if(!empty($groups))
        {
            ...
            foreach($groups as $group)
            {
                ...
                <div class="pg-element-group-col">
                    <div class="col-uimfield" title="<?php echo $group->group_name; ?>">
                  <?php echo $group->group_name; ?>
                </div>
                <div class="col-uiminput">
                   <input name="pm_show_group_on_groups_page_<?php echo $group->id; ?>" id="pm_show_group_on_groups_page_<?php echo $group->id; ?>" type="checkbox" <?php checked($dbhandler->get_global_option_value($option_name,'1'),'1'); ?> class="pm_toggle" value="1" style="display:none;" />
                  <label for="pm_show_group_on_groups_page_<?php echo $group->id; ?>"></label>
                </div>
