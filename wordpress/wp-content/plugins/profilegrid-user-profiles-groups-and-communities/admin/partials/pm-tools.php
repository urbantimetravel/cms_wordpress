...
<div class="uimagic">
  <div class="content pm_settings_option">
    ...
    <a href="admin.php?page=pm_performance_options">
      <div class="pm_setting_image"> 
      	<img src="<?php echo $path;?>images/performance.png" class="options" alt="options"> 
      </div>
      <div class="pm-setting-heading"> 
          <span class="pm-setting-icon-title"><?php _e( 'performance','profilegrid-user-profiles-groups-and-communities' ); ?></span> 
          <span class="pm-setting-description"><?php _e( 'Increase site performance.','profilegrid-user-profiles-groups-and-communities' ); ?></span> 
      </div>
    </a> 
    </div>
