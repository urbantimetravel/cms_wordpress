...
<div class="uimagic">
    ...
    <div class="content">
     ...
     <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Step 1: Alrighty then, let\'s get rolling! First step is simple. Select the CSV file containing users you wish to import to ProfileGrid.','profilegrid-user-profiles-groups-and-communities');?><a target="_blank" href="https://profilegrid.co/documentation/tools/"><?php _e('More','profilegrid-user-profiles-groups-and-communities');?></a></div>
      </div>
