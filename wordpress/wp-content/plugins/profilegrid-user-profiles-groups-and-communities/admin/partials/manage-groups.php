...
<div class="pmagic pg-group-manager"> 
  ...
  <div class="pmagic-cards">
    ...
    <div class="pm-card">
      ...
      <div class="pm-last-submission"> <b><?php _e("Latest members",'profilegrid-user-profiles-groups-and-communities');?></b></div>
      <?php foreach($users as $user):?>
      <div class="pm-last-submission"><a href="admin.php?page=pm_profile_view&id=<?php echo $user->ID; ?>"><?php echo get_avatar($user->user_email,16,'',false,array('class'=>'pm-user','force_display'=>true));?> </a><span class="pg-submission-date"> <?php //echo $user->user_registered; 
      echo date_i18n( get_option( 'date_format' ), strtotime($user->user_registered) ). " <span class='pg-submission-time'>". date_i18n( get_option( 'time_format' ), strtotime($user->user_registered) );?></span></span> </div>
      <?php endforeach;?>
