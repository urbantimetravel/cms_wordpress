...
class Profile_Magic_Activator {
	...
	public function create_pages() {
		$dbhandler = new PM_DBhandler;
                $pmrequest = new PM_request;
		$pages['profilegrid_register'] = array('post_type' => 'page','post_title' => __('Registration','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[profilegrid_register gid="1"]');
		$pages['profilegrid_group'] = array('post_type' => 'page','post_title' => __('Default User Group','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[profilegrid_group gid="1"]');
		$pages['profilegrid_groups'] = array('post_type' => 'page','post_title' => __('All Groups','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[profilegrid_groups]');
		$pages['profilegrid_login'] = array('post_type' => 'page','post_title' => __('Login','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[profilegrid_login]');
		$pages['profilegrid_profile'] = array('post_type' => 'page','post_title' => __('My Profile','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[profilegrid_profile]');
		$pages['profilegrid_forgot_password'] = array('post_type' => 'page','post_title' => __('Forgot Password','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[profilegrid_forgot_password]');
		$pages['profilegrid_submit_blog'] = array('post_type' => 'page','post_title' => __('Submit New Blog Post','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[profilegrid_submit_blog]');
                $pages['profilegrid_users'] = array('post_type' => 'page','post_title' => __('Search Users','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[profilegrid_users]');
                $pages['profilegrid_user_blogs'] = array('post_type' => 'page','post_title' => __('User Blogs','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[profilegrid_user_blogs]');
		// The Query
		...
		foreach($page_id as $key=>$id) {
			if($key=='profilegrid_register')$field = 'pm_registration_page';
			if($key=='profilegrid_group')$field = 'pm_group_page';
			if($key=='profilegrid_groups')$field = 'pm_groups_page';
			if($key=='profilegrid_login')$field = 'pm_user_login_page';
			if($key=='profilegrid_profile')$field = 'pm_user_profile_page';
			if($key=='profilegrid_forgot_password')$field = 'pm_forget_password_page';
			if($key=='profilegrid_submit_blog')$field = 'pm_submit_blog';
                        if($key=='profilegrid_users')$field = 'pm_search_page';
                        if($key=='profilegrid_user_blogs')$field = 'pm_user_blogs_page';
